...
function BusinessDetail({ user, addReviews, users }) {
        ...
        <Container>
            <Row>
                <Col>
                    ...
                    {user ? <AddReview business_id={business.id} addReviews={addReviews} /> : <Button>Log In or Sign Up to leave review</Button>}
